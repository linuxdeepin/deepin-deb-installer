...
{
    m_appendPackageThread = new AppendPackageThread(m_fileListModel, m_lastPage, packages, this);
    connect(m_appendPackageThread, &AppendPackageThread::refresh, this, &DebInstaller::refreshInstallPage);
    connect(m_appendPackageThread, &AppendPackageThread::packageAlreadyAdd, this, &DebInstaller::popFloatingError);
    m_appendPackageThread->start();
}
