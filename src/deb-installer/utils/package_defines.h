...
enum DependsStatus {
    ...
    CompatibleNotInstalled,  // Package depends break, and not installed in compatible mode
    CompatibleIntalled,      // Package depends ok, but installed in compatible mode
};
